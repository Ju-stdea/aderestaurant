                ...
                @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{ Auth::guard('admin')->user()->email }}" type="email" readonly >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Admin Type</label>
                        <input class="form-control" value="{{ Auth::guard('admin')->user()->type }}" type="text" readonly >
                      </div>
                        
                    <div class="form-group">
                        <label for="exampleInputPassword1">Name</label>
                        <input type="text" class="form-control" name="admin_name" id="admin_name" value="{{ Auth::guard('admin')->user()->name }}" placeholder="Enter Current Password" required>
                      </div>
                      <div class="form-group">
