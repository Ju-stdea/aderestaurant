                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Non Guest Customers</a></li>
                            <li class="active">List All Non Guest Customers</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <strong class="card-title">All Non Guest Customers</strong>
                </div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                        ...
                        @foreach($nonguestcustomers as $customer)
                            <tbody>
