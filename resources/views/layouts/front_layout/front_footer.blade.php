                    ...
                    <div class="wrapper">
                        ...
                        <form action="{{ route('subscribe') }}" method="get">
                            ...
                            <div class="footer-btn" data-aos="fade-right">
                                ...
                                <a class="shop-btn">
                                    <button type="submit" style="background-color: none;">
                                        Subscribe
                                    </button>
                                </a>
                            </div>
        ...
        <div class="container">
                ...
                <div class="row gy-5">
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-order">
                            <div class="logo">
                                <img src="{{ asset('images/front_images/logos/footer-logo.png') }}" alt="logo">
                            </div>
                            <div class="footer-link order-link">
                                <ul>
                                    {{-- <li><a href="{{ url('orders/track-order') }}">Track Order</a></li> --}}
                                    <li><a href="{{ url('carts') }}">Carts</a></li>
                                    <li><a href="{{ url('products/flash-sale') }}">Flash sales</a></li>
                        ...
                        <div class="links">
                            ...
                            <div class="footer-link useful-link">
                                <ul>
                                    ...
                                    <li><a href="{{ url('returns-and-refund') }}">Return and Refunds</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="contact-info">
                            ...
                            <div class="footer-link contact-link">
                                <div class="social-items" style="width: 50%;">
                                    <a href="https://www.instagram.com/amras_foods/" class="social-icon instagram">
                                        <span>
                                    ...
                                    <a href="#" class="social-icon facebook">
                                        <span>
                                            <svg width="30" height="30" viewBox="0 0 10 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <a href="#" class="social-icon youtube">
                                        <span>
                                            <svg width="30" height="30" viewBox="0 0 16 12" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="address">
                                    ...
                                    <div class="details">
                                        ...
                                        <p>244 E 35th street Chicago Illinois 60616</p>
                                    </div>
                                </div>
                                ...
                                <div class="email address">
                                    ...
                                    <div class="details">
                                        ...
                                        <p>amrasafricangrocery@gmail.com </p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom-section">
                <div class="footer-social">
                    ...
                    <div class="copyright">
                        <p>©2024 <a href="#" target="_blank" class="inner-text">Designed by A-$oft</a> All
                            rights reserved</p>
                    </div>
                </div>
                <div class="footer-payment-mode">
                    <a href="#">
                        <img src="{{ asset('images/front_images/homepage-one/payment-img.png') }}" alt="img">
                    </a>
                </div>
            </div>
        </div>
