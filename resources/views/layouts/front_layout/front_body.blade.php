                    ...
                    <div class="swiper-slide hero-slide">
                        <div class="hero-wrapper-slide wrapper-slide"> 
                            ...
                            <div class="wrapper-img">
                                <img src="{{ asset('images/front_images/homepage-one/hero-img-1.webp') }}" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide hero-slide">
                        <div class="hero-wrapper-slide wrapper-slide">
                            ...
                            <div class="wrapper-img" data-aos="fade-left">
                                <img src="{{ asset('images/front_images/homepage-one/hero-img-2.webp') }}" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide hero-slide">
                        <div class="hero-wrapper-slide wrapper-slide">
                            ...
                            <div class="wrapper-img" data-aos="fade-left">
                                <img src="{{ asset('images/front_images/homepage-one/hero-img-3.webp') }}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="category-section">
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                <div class="wrapper-img">
                    <img src="{{ asset('images/front_images/homepage-one/category-img/c-img-1.webp') }}" alt="img">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                <div class="wrapper-img">
                    <img src="{{ asset('images/front_images/homepage-one/category-img/c-img-2.webp') }}" alt="img">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                <div class="wrapper-img">
                    <img src="{{ asset('images/front_images/homepage-one/category-img/c-img-3.webp') }}" alt="img">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                <div class="wrapper-img">
                    <img src="{{ asset('images/front_images/homepage-one/category-img/c-img-4.webp') }}" alt="img">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                <div class="wrapper-img">
                    <img src="{{ asset('images/front_images/homepage-one/category-img/c-img-5.webp') }}" alt="img">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="600">
                <div class="wrapper-img">
                    <img src="{{ asset('images/front_images/homepage-one/category-img/c-img-6.webp') }}" alt="img">
                </div>
                <div class="wrapper-info">
            ...
            <div class="row gy-4 gx-5 gy-lg-0">
                <div class="col-lg-4 col-md-6">
                    <div class="product-wrapper wrapper-one" data-aos="fade-up">
                        ...
                        <div class="wrapper-img">
                            <img src="{{ asset('images/front_images/homepage-one/category-img/c-shop-img-1.webp') }}" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="product-wrapper wrapper-two" data-aos="fade-up">
                        <div class="wrapper-img">
                            <img src="{{ asset('images/front_images/homepage-one/category-img/c-shop-img-2.webp') }}" alt="img">
                        </div>
                        <div class="wrapper-info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-wrapper wrapper-three" data-aos="fade-up">
                        ...
                        <div class="wrapper-img">
                            <img src="{{ asset('images/front_images/homepage-one/category-img/c-shop-img-3.webp') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="fresh-section">
            <div class="row g-5">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-1.webp') }}" alt="product-img">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-2.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-3.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-4.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
        ...
        <div class="top-selling-section">
            <div class="row g-5">
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-5.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-6.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-7.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-8.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-9.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-10.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
        ...
        <div class="arrival-section">
            <div class="row g-5">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-15.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-16.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-17.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-18.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-19.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-20.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-21.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-22.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-23.webp') }}" alt="product-img">
                            <div class="product-cart-items">
                                <a href="#" class="cart cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-24.webp') }}" alt="product-img">
        ...
        <div class="popular-sale-section">
            <div class="row g-5">
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-26.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-29.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-31.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-34.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-27.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-30.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-32.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-35.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-28.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-12.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-33.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{ asset('images/front_images/homepage-one/product-img/p-img-36.webp') }}" alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">Fresh Red Tomatos
