...
<header id="header" class="header">
    <div class="header-top-section">
        <div class="container header-top-conianer">
                ...
                <div class="header-contact d-none d-lg-block">
                    <div class="header-top-contact">
                        <a href="#" class="top-contact phone">
                            ...
                            <span class="contact-text">+1 773-996-2287</span>
                        </a>
                        ...
                        <a href="#" class="top-contact email">
                            ...
                            <span class="contact-text">amrasafricangrocery@gmail.com </span>
                        </a>
                    </div>
                </div>
                <div class="header-profile">
                    ...
                    @auth
                        ...
                        <form method="get" action="{{ route('logout') }}">
                            @csrf
                            <button style="border: none; background-color: none; color: white;" type="submit">
                    ...
                    @endauth
                    {{-- <a href="{{ url('orders/track-order') }}"><span>Track Order</span></a> --}}
                </div>
            </div>
        </div>
    </div>
    <div class="header-center-section d-none d-lg-flex">
        <div class="container">
            <div class="header-center">
                <div class="logo">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('images/front_images/logos/logo.png') }}" alt="logo">
                    </a>
                </div>
                <form action="{{ route('search') }}" method="GET">
                    <div class="header-search-btn">
                        ...
                        <div class="divider"></div>
                        <div id="allcat">
                            <input type="hidden" class="categoryInput" name="category">
                            <button type="button" onclick="selectBoxHandler('allcat')">
                                <span class="item-text" id="text-input">All Categories</span>
                                <span>
                            ...
                            <div class="slectbox-body" style="display: none;">
                                ...
                                <ul class="country-options">
                                    @foreach ($categories as $category)
                                        <li class="all-option">
                                            <span class="option-text item-text">
                        ...
                        <a class="shop-search-btn"><button style="color: white;">Search</button></a>
                ...
                <div class="header-cart-items">
                                ...
                                <span>
                                    <svg width="28" height="23" viewBox="0 0 28 23" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#F9FFFB" />
                                        <circle cx="20.9141" cy="7" r="7.5" fill="#34A853" />
                                        <text x="20.9141" y="12" text-anchor="middle" font-size="10"
                                            fill="white">{{ $wishLiistCount }}</text>
                                    </svg>
                                </span>
                    ...
                    <div class="header-cart">
                        <a href="{{ url('carts') }}" class="cart-item">
                            <span>
                                <svg width="24" height="23" viewBox="0 0 24 23" fill="none"
                                    ...
                                    <p
                                        style="position: absolute; top: 0; right: 0; background-color: #34A853; height: 15px; width: 15px; border-radius: 50%; color: white; font-size: 0.75rem; display: flex; align-items: center; justify-content: center; margin: 3px;">
                                        {{ $totalQuantity }}</p>
                                    <path
                                        ...
                                        <div class="wrapper">
                                            <div class="wrapper-item">
                                                ...
                                                <div class="wrapper-content">
                                                    <h5 class="wrapper-title">{{ $item['product_name'] }}</h5>
                                                    <div class="price">
                                                        <?php $discounted_price = Product::getDiscountedPrice($item['id']); ?>
                                                        @if ($discounted_price > 0)
                                                            <span class="new-price">${{ $discounted_price }} x
                                                                {{ $item['quantity'] }}</span>
                                                        @else
                                                            <span class="new-price">${{ $item['product_price'] }} x
                                                                {{ $item['quantity'] }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                ...
                                @else
                                    <div class="wrapper">
                                        <div class="container text-center">
                                            ...
                                            <a href="{{ url('products') }}" class="shop-btn">Products</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
                            @if (count($cart) > 0)
                                <div class="cart-wrapper-section">
                                    ...
                                    <div class="wrapper-subtotal">
                                        ...
                                        <h5 class="wrapper-title">${{ $totalAmount }}</h5>
                                    </div>
                                    <div class="cart-btn">
                                        <a href="{{ url('carts') }}" class="shop-btn view-btn">View Cart</a>
    ...
    <nav class="mobile-menu d-block d-lg-none">
        <div class="mobile-menu-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ url('/') }}" class="mobile-header-logo">
                <img src="{{ asset('images/front_images/logos/logo-copy.png') }}" alt="logo">
            </a>
            <a href="{{ url('carts') }}" class="header-cart cart-item">
                <span>
                    <svg width="24" height="23" viewBox="0 0 24 23" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                        ...
                        <!-- <circle cx="17" cy="7" r="7" fill="#34A853" /> -->
                        <p
                            style="position: absolute; top: 7%; right: 8px; background-color: #34A853; height: 15px; width: 15px; border-radius: 50%; color: white; font-size: 0.75rem; display: flex; align-items: center; justify-content: center; margin: 3px;">
                            {{ $totalQuantity }}</p>
                        <path
                            d="M17.0036 10.1087C16.4986 10.1065 16.0672 9.97337 15.7092 9.70916C15.3513 9.44496 15.0775 9.06037 14.8878 8.5554C14.6982 8.05043 14.6034 7.44212 14.6034 6.73047C14.6034 6.02095 14.6982 5.41477 14.8878 4.91193C15.0796 4.40909 15.3544 4.02557 15.7124 3.76136C16.0725 3.49716 16.5029 3.36506 17.0036 3.36506C17.5043 3.36506 17.9336 3.49822 18.2916 3.76456C18.6495 4.02876 18.9233 4.41229 19.113 4.91513C19.3047 5.41584 19.4006 6.02095 19.4006 6.73047C19.4006 7.44425 19.3058 8.05362 19.1162 8.55859C18.9265 9.06143 18.6527 9.44602 18.2948 9.71236C17.9368 9.97656 17.5064 10.1087 17.0036 10.1087ZM17.0036 9.25533C17.4468 9.25533 17.793 9.03906 18.0423 8.60653C18.2937 8.17401 18.4194 7.54865 18.4194 6.73047C18.4194 6.18714 18.3619 5.72798 18.2468 5.35298C18.1339 4.97585 17.9709 4.69034 17.7579 4.49645C17.5469 4.30043 17.2955 4.20241 17.0036 4.20241C16.5625 4.20241 16.2163 4.41974 15.9649 4.8544C15.7135 5.28906 15.5867 5.91442 15.5846 6.73047C15.5846 7.27592 15.641 7.73722 15.754 8.11435C15.869 8.48935 16.032 8.77379 16.2429 8.96768C16.4539 9.15945 16.7074 9.25533 17.0036 9.25533Z"
                            fill="#FFFFFF" />
                                    ...
                                    <a href="{{ url('products/category', $category->id) }}">
                                        <div class="dropdown-item d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="drop-down-list-icon">
                                                <span>
                                                    <svg width="15" height="15" viewBox="0 0 6 9"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="header-nav-menu-section">
                                            ...
                                            <div
                                                ...
                                                <div class="dropdown-list-item d-flex">
                                                    <span class="dropdown-img">
                                                        <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                            data-icon="anchor"
                                                            class="svg-inline--fa fa-anchor w-4 h-4" role="img"
                                                ...
                                                <div class="drop-down-list-icon">
                                                    <span>
                                                        <svg width="10" height="10" viewBox="0 0 6 9"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="header-nav-menu">
                        <ul class="menu-list">
                            ...
                            @endif
                            <li>
                                <a href="{{ url('products/flash-sale') }}">
                                    <span class="list-text">Flash Sales</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('contact') }}">
