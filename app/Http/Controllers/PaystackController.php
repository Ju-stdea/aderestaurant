...
class PaystackController extends Controller
{
    ...
    public function payPalCheckOut(Request $request)
    {
        ...
        try {
            ...
            $order->transaction_id = 'paystack_' . uniqid();
            ...
            if ($approvalLink) {
                ...
                return response()->json(['error' => 'Paystack approval link not found.'], 500);
            }
        } catch (\Exception $e) {
            Log::error('Paystack Checkout Error: ' . $e->getMessage(), ['exception' => $e]);

            return response()->json(['error' => 'An error occurred during Paystack checkout. Please try again.'], 500);
        }
    }
